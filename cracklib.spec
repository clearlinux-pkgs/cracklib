...
Version  : 2.9.8
Release  : 50
URL      : https://github.com/cracklib/cracklib/releases/download/v2.9.8/cracklib-2.9.8.tar.gz
Source0  : https://github.com/cracklib/cracklib/releases/download/v2.9.8/cracklib-2.9.8.tar.gz
...
%prep
%setup -q -n cracklib-2.9.8
cd %{_builddir}/cracklib-2.9.8
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662666721
